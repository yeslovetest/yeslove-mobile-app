...
const getHelpSlice = createSlice({
  ...
  reducers: {
    ...
    setProfessionalsError: (state, action: PayloadAction<string>) => {
      state.professionalsLoading = false;
      state.professionalsError = action.payload;
    },
    setProfessionals: (
      state,
