...
const Footer = () => {
  ...
  return (
    <View style={styles.footer}>
      <FooterButton
        tab={{ type: TabType.HOME, data: { userId: userId } }}
        icon="home-outline"
        selectedIcon="home"
        title="Home"
      ></FooterButton>
      <FooterButton
        tab={{ type: TabType.GET_HELP }}
        icon="bulb-outline"
        selectedIcon="bulb"
        title="Get help"
      ></FooterButton>
      <FooterButton
        tab={{ type: TabType.NOTIFICATIONS }}
      ...
      <FooterButton
        tab={{ type: TabType.EVENTS }}
        icon="calendar-outline"
        selectedIcon="calendar"
        title="Events"
      ></FooterButton>
      <FooterButton
        tab={{ type: TabType.PROFILE, data: { userId: userId } }}
        icon="person-outline"
        selectedIcon="person"
        title="Profile"
      ></FooterButton>
