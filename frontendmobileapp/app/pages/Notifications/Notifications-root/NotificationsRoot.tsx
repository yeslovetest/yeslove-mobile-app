...
const NotificationsRoot = () => {
  ...
  const isFetchingNotifications = useAppSelector(
    (state) => state.notification.isFetchingNotifications,
  );
  ...
  useFocusEffect(
    // maintain previous scroll position after user returns to this screen via the Back button
    React.useCallback(() => {
  ...
  const hasMoreNotifications =
    notificationList.length < totalNotifications && currentPage * perPage < totalNotifications;
    ...
    <>
      ...
      >
        <View style={styles.headerRow}>
          ...
          <Text style={styles.noOfNotifications}>
            You have <Text style={styles.blueText}>{unreadNotifications} unread notfications</Text>
          </Text>
            ...
            >
              <Text
                style={[
                  ...
                  activeTab === "all" ? styles.tabButtonTextActive : styles.tabButtonTextInactive,
                ]}
              >
                All
              </Text>
        ...
        {activeTab === "all" &&
          nonFriendRequestNotifications.map((notification, index) => (
            <OneNotification
        ...
        {activeTab === "friend_requests" &&
          friendRequestList.map((request) => (
            <OneNotification key={request.keycloak_id} friendRequest={request} />
          ))}
