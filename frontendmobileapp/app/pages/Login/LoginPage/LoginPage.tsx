...
const LoginPage = () => {
  ...
  return (
    <ImageBackground
      source={image}
      style={[styles.container, isCompactScreen ? styles.compactContainer : undefined]}
      resizeMode="cover"
        ...
        >
          <View
            style={[
              ...
              isCompactScreen ? styles.compactInnerContainer : undefined,
            ]}
          >
            <Text style={[styles.title, isCompactScreen ? styles.compactTitle : undefined]}>
              LOGIN
            </Text>
            ...
            <Text
              style={{
                ...styles.errorMessage,
                ...(isCompactScreen ? styles.compactErrorMessage : undefined),
            ...
            <View
              style={[
                ...
                isCompactScreen ? styles.compactModeToggleContainer : undefined,
              ]}
            >
              <TouchableOpacity
                style={[
            ...
            <Text style={[styles.label, isCompactScreen ? styles.compactLabel : undefined]}>
            ...
            <TextInput
              ...
              style={{
                ...styles.input,
                ...(isCompactScreen ? styles.compactInput : undefined),
                borderColor: identifierBdColor[0],
                borderBottomColor: identifierBdColor[1],
              }}
