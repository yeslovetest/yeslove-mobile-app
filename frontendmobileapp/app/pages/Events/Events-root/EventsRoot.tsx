  ...
  return (
    <>
      ...
      >
        <OrangeBanner
          icon="icons"
          description="Browse our past and future events"
          mainTitle="Our Events"
        />
        <EventNavbar />
        {currentTab === "Upcoming" && <UpcomingContent dates={filtersByTab.Upcoming} />}

        {currentTab === "Attending" && <AttendingContent dates={filtersByTab.Attending} />}

        {currentTab === "Attended" && <AttendedContent dates={filtersByTab.Attended} />}
      </ScrollView>
    </>
  );
}
