...
import { FeedTabs, setScrollViewPosition } from '../../../store/Home-store/feedSlice';
...
export default function HomeRoot() {
  ...
  return (
    <>
      ...
      <ScrollView ref={scrollViewRef} contentContainerStyle={sharedStyles.contentContainer} style={sharedStyles.container}
