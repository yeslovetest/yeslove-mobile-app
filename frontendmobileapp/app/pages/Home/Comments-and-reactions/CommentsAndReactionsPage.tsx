...
const IndividualPost = () => {
  ...
  const individualPost: Post = useAppSelector(
  ...
  const [reactionType, setReactionType] = useState(
    individualPost.current_user_reaction ?? "default",
  );
  ...
  const openProfile = () => {
    if (individualPost.author_id) {
      dispatch(
        openTabOnTopAction({ type: TabType.PROFILE, data: { userId: individualPost.author_id } }),
      );
    }
  };
        ...
        <View style={styles.keyboardContainer}>
          ...
          >
            <View style={[styles.postContainer, styles.indPostContainer]}>
              <View style={styles.profileImageContainer}>
                ...
                <View style={styles.profileInfoContainer}>
                  ...
                  <Text style={styles.timePosted}>
                    {individualPost.timestamp
                      ? dayjs(individualPost.timestamp).format("MMM D, YYYY h:mm A")
                      : "Unknown date"}
                  </Text>
                </View>
              </View>
              ...
              <Text style={styles.postContent}>{individualPost.content}</Text>
              ...
              <View style={[styles.homeNavBar, styles.indPostNavBar]}>
                ...
                >
                  ...
                  {reactionTypeTab === "reactions" && (
                    <Text style={styles.activeHomeNavText}>Reactions</Text>
                  )}
                ...
                >
                  ...
                  {reactionTypeTab === "comments" && (
                    <Text style={styles.activeHomeNavText}>Comments</Text>
                  )}
