...
const Email = (props: Props) => {
    ...
    const checkBoxList1 = [
        ...
        {label: 'when your post or comment gets a reply' ,
         onPress: () => changeEmailSetting(1)
        },
    ];
    const checkBoxList2 = [
        {label: 'when you receive a new message',
         onPress: () => changeEmailSetting(2)
        },
    ];
    const checkBoxList3 = [
        {label: 'when you receive a membership invitation',
         onPress: () => changeEmailSetting(3)
        },
    ];
    const checkBoxList4 = [
        {label: 'when you receive a friendship request',
         onPress: () => changeEmailSetting(4)
        },
    ...
    const checkBoxList5 = [
        {label: 'when you receive an invite to join a group',
         onPress: () => changeEmailSetting(6)
        },
        {label: 'when group information is updated' ,
         onPress: () => changeEmailSetting(7)
        },
    ...
    return (
        ...
        <View style={styles.settingsNavItemContainer}>
            ...
            <CheckBoxList header="Messages" items={checkBoxList2} 
            state={[currentSettings[2]]}/>

            <CheckBoxList header="Members" items={checkBoxList3} 
            state={[currentSettings[3]]}/>

            <CheckBoxList header="Friends" items={checkBoxList4} 
            state={[currentSettings[4], currentSettings[5]]}/>

            <CheckBoxList header="Groups" items={checkBoxList5} 
            state={[currentSettings[6],currentSettings[7],currentSettings[8],
