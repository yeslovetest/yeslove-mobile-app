...
const SettingsPage = () => {
  ...
  const settingsItems: Array<{
  ...
  }> = [
    {
      key: "general",
      label: "General",
      icon: <MaterialIcons name="display-settings" size={22} color={theme.colors.textPrimary} />,
      tab: TabType.GENERAL,
    },
    {
      key: "email",
      label: "Email",
      icon: <Fontisto name="email" size={20} color={theme.colors.textPrimary} />,
      tab: TabType.EMAIL,
    },
    {
      key: "profileVisibility",
      label: "Profile Visibility",
      icon: <Fontisto name="low-vision" size={20} color={theme.colors.textPrimary} />,
      tab: TabType.PROFILE_VISIBILITY,
    },
    {
      key: "notifications",
      label: "Push Notification Settings",
      icon: <Fontisto name="bell" size={20} color={theme.colors.textPrimary} />,
      tab: TabType.NOTIFICATION_PREFERENCES,
    },
    {
      key: "export",
      label: "Export Data",
      icon: <Ionicons name="share-social-outline" size={20} color={theme.colors.textPrimary} />,
    ...
    <>
      ...
      >
        <View style={settingsSharedStyles.pageHeaderRow}>
          ...
          <Text style={settingsSharedStyles.pageSubtitle}>
