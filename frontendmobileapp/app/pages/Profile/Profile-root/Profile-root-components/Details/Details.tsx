...
const userId = useAppSelector(state => state.user.id);
  ...
  const openEditProfileInformation = () => {
    dispatch(openTabOnTopAction({ type: TabType.EDIT_PROFILE_INFORMATION,  data: { userId: userId }  }))
  }
  return (
    <>
    ...
    <View style={styles.buttonContainer}>
        <TouchableOpacity onPress={openEditProfileInformation}  style={styles.button}><Text style={styles.buttonText}>Edit your profile information</Text></TouchableOpacity>
    </View>
    </>
  )
}
