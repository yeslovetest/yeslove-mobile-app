...
const Page3 = () => {
  ...
  const isAccountExists =
    normalizedLower.includes("already exists") || normalizedLower.includes("already registered");
        ...
        >
          <View style={styles.innerContainer}>
            ...
            <Text style={styles.label}>
              {normalizedResponse ||
                `We have sent a verification link to your email address: ${signupEmail}`}
            </Text>
          ...
          <View style={styles.innerContainer}>
            ...
            <TouchableOpacity
              style={[
                styles.baseButton,
                styles.backButton,
                isSignupSubmitting ? styles.disabledButton : null,
              ]}
              onPress={signupActions.moveToPrevious}
              disabled={isSignupSubmitting}
            >
