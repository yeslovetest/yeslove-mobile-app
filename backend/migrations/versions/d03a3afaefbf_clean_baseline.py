...
Revision ID: d03a3afaefbf
Revises: 
Create Date: 2025-10-08 22:18:56.216534
...
def _embedding_type():
    ...
    if dialect == "postgresql" and Vector is not None:
        # Make sure the vector extension exists on PG
        op.execute("CREATE EXTENSION IF NOT EXISTS vector")
        return Vector(1536)  # same dim you expect
    else:
        # Dev/SQLite fallback: store embedding as text (e.g., JSON string)
        return sa.Text()
