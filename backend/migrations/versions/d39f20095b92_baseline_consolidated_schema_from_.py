"""baseline: consolidated schema from current models

Revision ID: d39f20095b92
Revises: 
Create Date: 2026-09-18 13:37:40.796790
...
def upgrade():
    ...
    sa.Column('follows_enabled', sa.Boolean(), nullable=True),
    ...
    op.create_table('video_podcasts',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('wp_post_id', sa.Integer(), nullable=True),
    sa.Column('source', sa.String(length=50), nullable=True),
    sa.Column('title', sa.String(length=255), nullable=False),
    ...
    sa.ForeignKeyConstraint(['post_id'], ['post.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('post_id', 'media_id', name='unique_post_media')
    )
