<<<<<<<< HEAD:backend/migrations/versions/e76b5761d92a_device_token_and_places_column_addition.py
"""Device token and places column addition.

Revision ID: e76b5761d92a
Revises: 
Create Date: 2025-10-05 22:26:56.393822
========
"""Initial migration
...
>>>>>>>> 7ee3108179f46107aa84b8bb565319e3122f17ab:backend/migrations/versions/0ed84cb9a115_initial_migration.py
...
<<<<<<<< HEAD:backend/migrations/versions/e76b5761d92a_device_token_and_places_column_addition.py
    ...
    # Creates ivfflat index only on postgres
    bind = op.get_bind()
...
<<<<<<<< HEAD:backend/migrations/versions/e76b5761d92a_device_token_and_places_column_addition.py
    ...
    op.create_index("ix_device_token_user_device", "device_token", ["user_id", "device_id"], unique=False)
...
<<<<<<<< HEAD:backend/migrations/versions/e76b5761d92a_device_token_and_places_column_addition.py
    ...
    op.drop_index("ix_device_token_user_device", table_name="device_token")
    op.drop_constraint("uq_device_token_user_device", "device_token", type_="unique")
========
    op.drop_table('media')
>>>>>>>> 7ee3108179f46107aa84b8bb565319e3122f17ab:backend/migrations/versions/0ed84cb9a115_initial_migration.py
    # ### end Alembic commands ###
